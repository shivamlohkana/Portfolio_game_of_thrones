...
export default function Hero() {
  ...
  return <section id="realm" className={`hero ${ready ? 'has-artwork' : ''}`} aria-labelledby="hero-title" style={{ '--hero-position': portfolio.hero.position, '--hero-mobile-position': portfolio.hero.mobilePosition }}>
    <div className="hero-art"><div className="hero-stage"><AssetImage src={portfolio.hero.src} alt="" priority onReady={() => setReady(true)} className="hero-image"><div className="hero-placeholder" aria-hidden="true"><div className="archive-frame frame-outer" /><div className="archive-frame frame-inner" /><span className="archive-monogram">{portfolio.initials}</span><span className="placeholder-annotation">THE ROYAL ARCHIVE <i /> ARTWORK FORTHCOMING</span></div></AssetImage><FireOverlay ready={ready} /></div></div>
